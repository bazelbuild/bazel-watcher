...
git_repository(
    ...
    commit = "9af28bdd3472c17053aa84833a8d9c2f3ce5718e",
...
http_archive(
    ...
    urls = [
        "https://mirror.bazel.build/github.com/bazelbuild/rules_go/releases/download/0.17.0/rules_go-0.17.0.tar.gz",
