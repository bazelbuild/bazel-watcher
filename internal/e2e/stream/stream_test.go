...
func TestSimpleTest(t *testing.T) {
	...
	ibazel.ExpectOutput("TestSimpleTest1", 30)
	...
	ibazel.ExpectOutput("TestSimpleTest2", 30)
}
...
func TestSingleQueryTarget(t *testing.T) {
	...
	ibazel.ExpectOutput("TestSingleQueryTarget", 30)
}
...
func TestMultipleQueryTarget(t *testing.T) {
	...
	ibazel.ExpectOutput("TestMultipleQueryTarget", 30)
}
