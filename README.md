...
* stopAfter (optional): a number (0-127) of failures (non-0 exit codes from the `command`) after which to discard any remaining output.
    * default value: 127
    * no-op with `--run_output_interactive=true`
